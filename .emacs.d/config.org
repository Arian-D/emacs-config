...
** Hide GTK window decoration in River
As advised [[https://codeberg.org/river/wiki#woraround-for-emacs][here]],
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package empv
    ...
    :custom
    (empv-invidious-instance "https://invidious.incogniweb.net/api/v1"))
#+end_src
