...
#+begin_src emacs-lisp
  (let ((default-font "Iosevka Fixed")
        (variable-font "Latin Modern Roman"))
...
#+begin_src emacs-lisp
  (use-package gptel
    ...
    (gptel-backend (gptel-make-openai "llama-cpp"
                     ...
                     :host "localhost:8080"
                     :models '(test)))
    ;; Replace thinking blocks for deepseek
    :hook (gptel-post-response . (lambda (begin end)
                                   (replace-string "<think>" "#+begin_thought" nil begin end)
                                   (replace-string "</think>" "#+end_thought" nil begin end))))
#+end_src
